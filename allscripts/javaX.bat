...
if %1 == "Java 17" (
  set JAVA_HOME=D:\Programming\EclipseAdoptium\jdk-17.0.8.7-hotspot
  set MAVEN_HOME=D:\Programming\EclipseAdoptium\apache-maven-3.9.3
)
